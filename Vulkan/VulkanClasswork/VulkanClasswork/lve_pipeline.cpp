...
namespace lve
{
	...
	void LvePipeline::defaultPipelineConfigInfo(PipelineConfigInfo& configInfo)
	{
		...
		configInfo.inputAssemblyInfo.topology = VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST; // Specifies what to Interpret
	...
	{
		assert(configInfo.pipelineLayout != VK_NULL_HANDLE && "Cannot create grahics pipeline:: no pipelineLayout provided in configInfo");
		assert(configInfo.renderPass != VK_NULL_HANDLE && "Cannot create grahics pipeline:: no pipelineLayout provided in configInfo");
